...
import { getProjectTeam, removeUserTeam } from "@/api/TeamAPI"
...
const ProjectTeamPage = () => {
    ...
    const handleClickRemove = (id: Team['_id']) => {
        const data = {
            userID: id,
            projectID
        }
        ...
        <>
            ...
            <nav className=" my-5 flex gap-3">
                <button
                    ...
                    onClick={() => navigate(location.pathname + '?addTeam=true')}
            ...
            {isError && <p className=" text-center">Hubo un error</p>}
            {data && (
                <>
                                        ...
                                        <Menu as="div" className="relative flex-none">
                                            ...
                                            >
                                                <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                                                    <Menu.Item>
                                                        <button
                                                            onClick={() => handleClickRemove(member._id)}
                                                            type='button'
